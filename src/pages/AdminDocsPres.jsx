...
const AdminDocsPres = () => {
    ...
    const {docsPresSubir, docsPresIniciales} = React.useContext(GeneralContext);
    ...
    function addDocSubirHandler(e){
        ...
        // Añadir
        addDocSubir(nombreDocSubir.current.value, desDocSubir.current.value, "Prestador");
    }
    ...
    function addDocInicialHandler(e){
        ...
        // Añadir
        addDocInicial(nombreDocInicial.current.value, fileDocInicial.current.files[0], "Prestador");
    ...
    return (
        <div className="doc_page">
            ...
            <div>
                ...
                {/* HEADER SUBIR */}
                <h1 className="doc_title">Documentos a Subir Prestadores</h1>
                <h2>Esta es la lista de los documentos que deberán subir los prestadores, los documentos tienen un titulo y una descripción detallada sobre lo que se debe subir.</h2>
                        ...
                        <li className="lista_item lista_item_my list-group-item d-flex justify-content-between align-items-start" key={index}>
                            ...
                            <div className="list_actions">
                                <i 
                                    ...
                                    onClick={() => deleteDocSubir(doc?.nombre, doc?.des, "Prestador")}
                                ></i>
                            </div>
                        </li>
                    ))}
            ...
            <div>
                {/* HEADER INICALES */}
                <h1 className="doc_title">Documentos Iniciales Prestadores</h1>
                <h2>Estos son los documentos iniciales que podrán descargar los usuarios que sean prestadores.</h2>
                ...
                <ul className="list-group">
                    { docsPresIniciales.map( (doc, index) => (
                        <li className="lista_item list-group-item" key={index}>
                            ...
                            <i className="fas fa-times" onClick={() => deleteDocInicial(doc?.ref, "Prestador")}></i>
                        </li>
                    ))}
                </ul>
