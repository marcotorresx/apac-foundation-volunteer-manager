...
const AdminDocsRec = () => {
    ...
    const {docsRecSubir, docsRecIniciales} = React.useContext(GeneralContext);
    ...
    function addDocSubirHandler(e){
        ...
        // Añadir
        addDocSubir(nombreDocSubir.current.value, desDocSubir.current.value, "Recorridos");
    }
    ...
    function addDocInicialHandler(e){
        ...
        // Añadir
        addDocInicial(nombreDocInicial.current.value, fileDocInicial.current.files[0], "Recorridos");
    ...
    return (
        <div className="doc_page">
            ...
            <div>
                ...
                {/* HEADER SUBIR */}
                <h1 className="doc_title">Documentos a Subir Recorridos</h1>
                <h2>Esta es la lista de los documentos que deberán subir los usuarios tipo recorridos, los documentos tienen un titulo y una descripción detallada sobre lo que se debe subir.</h2>
                        ...
                        <li className="lista_item lista_item_my list-group-item d-flex justify-content-between align-items-start" key={index}>
                            ...
                            <div className="list_actions">
                                <i 
                                    ...
                                    onClick={() => deleteDocSubir(doc?.nombre, doc?.des, "Recorridos")}
                                ></i>
                            </div>
                        </li>
                    ))}
            ...
            <div>
                {/* HEADER INICALES */}
                <h1 className="doc_title">Doumentos Iniciales Recorridos</h1>
                <h2>Estos son los documentos iniciales que podrán descargar los usuarios que sean tipo recorridos.</h2>
                ...
                <ul className="list-group">
                    { docsRecIniciales.map( (doc, index) => (
                        <li className="lista_item list-group-item" key={index}>
                            ...
                            <i className="fas fa-times" onClick={() => deleteDocInicial(doc?.ref, "Recorridos")}></i>
                        </li>
                    ))}
                </ul>
